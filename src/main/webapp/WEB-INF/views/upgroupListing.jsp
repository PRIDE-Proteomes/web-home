...
<c:set var="upgroupFacets" value="${facetPage.content}"/>
...
<div id="upgroup_list">
  ...
  <div class="grid_24 clearfix">
    <nav id="breadcrumb">
      <p>
        ...
        <a href="${prideUrl}">PRIDE</a> &gt; <a href="${proteomesUrl}">PRIDE Proteomes</a> &gt; UniProt Entry groups
      </p>
    </nav>
  ...
  <section class="grid_24 clearfix">
    ...
    <%-- List of peptiforms --%>
    <c:if test="${not empty upgroupFacets}">
      <%-- Table and controls --%>
      ...
      <div id="search-result-table" class="grid_20 omega">
        ...
        <table class="summary-table">
          ...
          <tbody>
          <c:forEach var="upgroupFacet" items="${upgroupFacets}">
            <tr>
              <td>
                <spring:url var="viewerUPGroupUrl" value="/viewer/#group={upgroup_accession}">
                  <spring:param name="upgroup_accession" value="${upgroupFacet.value}" />
                </spring:url>
                <a href="${viewerUPGroupUrl}">${upgroupFacet.value}</a>
              </td>
              <td>
                ${upgroupFacet.valueCount}
              </td>
            </tr>
          </c:forEach>
          </tbody>
